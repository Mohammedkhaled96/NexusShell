; NexusShell Inno Setup Script (Standard GUI Installer)
...
OutputDir={#OutputDir}
OutputBaseFilename=NexusShell_Setup
...
Name: "addtopath"; Description: "Add application directory to the system PATH"; GroupDescription: "Advanced Options:"; Flags: unchecked
